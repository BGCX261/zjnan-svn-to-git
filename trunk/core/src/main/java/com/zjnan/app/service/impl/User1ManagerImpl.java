...
import com.zjnan.app.service.UserExistsException;
import com.zjnan.app.service.UserService;
 ...
 */
@WebService(serviceName = "UserService", endpointInterface = "com.zjnan.app.service.UserService")
public class User1ManagerImpl extends GenericManagerImpl<User, Long> implements User1Manager, UserService {
	/**
     * @param genericDao
     */
    public User1ManagerImpl(GenericDao<User, Long> genericDao) {
        super(genericDao);
