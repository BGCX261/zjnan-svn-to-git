...
<tr>
    <td>
        <select name="<c:out value="${param.leftId}"/>" multiple="multiple"
            onDblClick="moveSelectedOptions(this,$('#<c:out value="${param.rightId}"/>')[0],true)"
    ...
    <td class="moveOptions">
        <button name="moveRight" id="moveRight<c:out value="${param.listCount}"/>" type="button" 
            onclick="moveSelectedOptions($('#<c:out value="${param.leftId}"/>')[0],$('#<c:out value="${param.rightId}"/>')[0],true)">
            &gt;&gt;</button><br />
        <button name="moveAllRight" id="moveAllRight<c:out value="${param.listCount}"/>" type="button"
            onclick="moveAllOptions($('#<c:out value="${param.leftId}"/>')[0],$('#<c:out value="${param.rightId}"/>')[0],true)">
            All &gt;&gt;</button><br />
        <button name="moveLeft" id="moveLeft<c:out value="${param.listCount}"/>" type="button"
            onclick="moveSelectedOptions($('#<c:out value="${param.rightId}"/>')[0],$('#<c:out value="${param.leftId}"/>')[0],true)">
            &lt;&lt;</button><br />
        <button name="moveAllLeft" id="moveAllLeft<c:out value="${param.listCount}"/>" type="button"
            onclick="moveAllOptions($('#<c:out value="${param.rightId}"/>')[0],$('#<c:out value="${param.leftId}"/>')[0],true)">
            All &lt;&lt;</button>
    </td>
    <td>
